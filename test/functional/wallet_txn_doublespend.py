...
class TxnMallTest(LiquidcashTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 LCASH:
        ...
        # First: use raw transaction API to send 1240 LCASH to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 LCASH coin each
        ...
        # Node0's balance should be starting balance, plus 50LCASH for another
        ...
        # Node0's total balance should be starting balance, plus 100LCASH for 
