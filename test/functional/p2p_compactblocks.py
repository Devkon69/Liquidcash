...
# TestNode: A peer we use to send messages to liquidcashd, and store responses.
...
class CompactBlocksTest(LiquidcashTestFramework):
    ...
    # This test actually causes liquidcashd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that liquidcashd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for liquidcashd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # liquidcashd will not send blocktxn responses for blocks whose height is
