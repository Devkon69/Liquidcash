...
By default, liquidcashd will dump mempool on shutdown and
...
class MempoolPersistTest(LiquidcashTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give liquidcashd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent liquidcashd from writing mempool.dat to disk. Verify that `savemempool` fails")
