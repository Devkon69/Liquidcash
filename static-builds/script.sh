...
find ${DISTNAME}/bin -type f -executable -exec ../liquidcash/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../liquidcash/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/liquidcash/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/liquidcash/depends/SDKs/MacOSX10.11.sdk.tar.gz
