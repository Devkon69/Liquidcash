...
#ifndef LCASH_QT_LCASHGUI_H
#define LCASH_QT_LCASHGUI_H
...
/**
  Liquidcash GUI main class. This class represents the main window of the Liquidcash UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class LiquidcashGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit LiquidcashGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~LiquidcashGUI();
