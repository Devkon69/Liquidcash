...
#include "config/liquidcash-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatLiquidcashURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + LiquidcashUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatLiquidcashURI(info));
}
