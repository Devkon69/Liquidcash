...
#ifndef LCASH_QT_SENDASSETSENTRY_H
#define LCASH_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending liquidcashs.
...
#endif // LCASH_QT_SENDASSETSENTRY_H
