...
#ifndef LCASH_QT_LCASHUNITS_H
#define LCASH_QT_LCASHUNITS_H
...
/** Liquidcash unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class LiquidcashUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit LiquidcashUnits(QObject *parent);

    /** Liquidcash units.
      @note Source: https://en.liquidcash.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        LCASH,
...
typedef LiquidcashUnits::Unit LiquidcashUnit;

#endif // LCASH_QT_LCASHUNITS_H
