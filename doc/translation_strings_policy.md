...
This document provides guidelines for internationalization of the Liquidcash Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `liquidcash_en.ts` remains unchanged.
